...
function obtenerDatosUsuario(idUsuario) {
  $.ajax({
    ...
    url: "../procesos/usuarios/login/crud/obtenerDatosUsuario.php",
    success: function (respuesta) {
...
function actualizarUsuario() {
  $.ajax({
    ...
    url: "../procesos/usuarios/login/crud/actualizarUsuario.php",
    success: function (respuesta) {
      respuesta = respuesta.trim();
      if (respuesta == 1) {
        $("#tablaUsuariosLoad").load("usuarios/tablaUsuarios.php");
...
function resetPassword() {
  $.ajax({
    ...
    url: "../procesos/usuarios/login/extras/resetPassword.php",
    success: function (respuesta) {
      respuesta = respuesta.trim();
      if (respuesta == 1) {
        ...
        Swal.fire(
          ":(",
          "Error al actualizar el password! " + respuesta,
          "error",
        );
      }
    },
...
function cambioEstatusUsuario(idUsuario, estatus) {
  $.ajax({
    ...
    url: "../procesos/usuarios/login/extras/cambioEstatus.php",
    success: function (respuesta) {
      respuesta = respuesta.trim();
      if (respuesta == 1) {
        $("#tablaUsuariosLoad").load("usuarios/tablaUsuarios.php");
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      $.ajax({
        ...
        url: "../procesos/usuarios/login/crud/eliminarUsuario.php",
        success: function (respuesta) {
          respuesta = respuesta.trim();
          if (respuesta == 1) {
            $("#tablaUsuariosLoad").load("usuarios/tablaUsuarios.php");
