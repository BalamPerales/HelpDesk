...
<table class="table table-sm table-bordered dt-responsive nowrap" style="width:%100%" id="tablaReportesAdminDataTable">
    ...
    <tbody>
        <?php $contador=1; while($mostrar = mysqli_fetch_array($respuesta)){ ?>
        <tr>
            ...
            <td>
                <button class="btn btn-info btn-sm"  data-toggle="modal" data-target="#modalAgregarSolucionReporte" onclick="obtenerDatosSolucion('<?php echo $mostrar['idReporte'] ?>')">
                    Solucion
                </button>
